                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                    @if($stats['most_answered'])
                        <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                            ...
                            <p class="text-green-600 mt-2">{{ $stats['most_answered']['answer_count'] }} cevap
                                ({{ $stats['most_answered']['response_rate'] }}% katılım)</p>
                        </div>
                    @endif
                    ...
                    @if($stats['least_answered'])
                        <div class="bg-red-50 border border-red-200 rounded-lg p-6">
                            ...
                            <p class="text-red-600 mt-2">{{ $stats['least_answered']['answer_count'] }} cevap
                                ({{ $stats['least_answered']['response_rate'] }}% katılım)</p>
                        </div>
                    @endif
                </div>
            @endif
                    ...
                    <div class="bg-white rounded-lg shadow-md p-6">
                        <div class="mb-4">
                            <div class="flex justify-between items-start">
                                <div class="flex-1">
                                    <h3 class="text-xl font-bold text-gray-900">Soru {{ $index + 1 }}: {{ $question['title'] }}
                                    </h3>
                                ...
                                @foreach($question['results'] as $result)
                                    <div>
                                        <div class="flex justify-between items-center mb-2">
                                            ...
                                            <span class="text-sm text-gray-600">{{ $result['count'] }} oy
                            ...
                            @if(!empty($question['word_cloud']))
                                <div class="mb-6">
                                    ...
                                    <div class="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-lg p-8 border border-blue-100">
                                        <div class="flex flex-wrap gap-3 justify-center items-center">
                                            @foreach($question['word_cloud'] as $item)
                                                <span
                                                    class="font-bold text-gray-800 px-3 py-2 rounded-lg bg-white shadow-sm hover:shadow-md transition-shadow border border-gray-200"
                                    ...
                                    <p class="text-xs text-gray-500 mt-3">
                                        Toplam {{ $question['total_unique_words'] }} farklı kelime • Kelime boyutu kullanım sıklığını
                                        gösterir
                                    </p>
                                </div>
